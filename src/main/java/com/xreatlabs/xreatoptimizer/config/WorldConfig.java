...
public class WorldConfig {
        ...
        if (worldsSection != null) {
            for (String worldName : worldsSection.getKeys(false)) {
                ...
                if (worldSection != null) {
                    ...
                    settings.maxEntitiesPerWorld = worldSection.getInt("entity_limiter.max_entities", -1);
    ...
    private void createDefaultConfig() {
        try {
            ...
            config.options().header(
                ...
                "You can also protect specific chunks from being unloaded or tracked.\n" +
                "Format: world_name:chunk_x:chunk_z\n"
            );

            config.set("worlds.world.entity_limiter.enabled", false);
            config.set("worlds.world.entity_limiter.max_entities", -1);
    ...
    public int getMaxEntities(String worldName) {
        ...
        return plugin.getConfig().getInt("entity_limiter.default_entities_per_world", 500);
    }
    ...
    public void addProtectedChunk(String worldName, int chunkX, int chunkZ) {
        ...
        config.set("protected_chunks", new ArrayList<>(protectedChunks));
        saveConfig();
    ...
    public void setWorldSetting(String worldName, String setting, Object value) {
        config.set("worlds." + worldName + "." + setting, value);
        saveConfig();
        loadConfig();
    }
    ...
    public static class WorldSettings {
        ...
        public int maxEntitiesPerWorld = -1;
